...
public class Banco {
    ...
    public Banco(){
        Pessoa pessoa1 = new Pessoa("Joao da silva", "333333333");
        Pessoa pessoa2 = new Pessoa("Maria da silva", "44444444");

        //pessoa, agencia, numero
        ...
        Conta conta4 = new ContaEspecial(pessoa1, 123, 182, new BigDecimal(10_000));
        Conta conta5 = new ContaEspecial(pessoa2, 123, 222, new BigDecimal(10_000));
